...
const programId = new PublicKey('A4RDTZxpskjCkY9mWgkovkx5aXUYEwZHJkQ6uWi1nWWH')
...
async function initGlobalPool() {
  ...
  let [pool, bump] = await PublicKey.findProgramAddress([Buffer.from(GLOBAL_AUTHORITY_SEED)], programId)

  console.log('11111111111', wallet.publicKey.toBase58());
  await program.rpc.initialize(
    {
      accounts: {
        globalAuthority: pool,
        owner: wallet.publicKey,
        systemProgram: anchor.web3.SystemProgram.programId,
      }
    });
    console.log('2222222222222', pool.toBase58());
